...
<html lang="en">
  <head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="{{ asset('asset/backend/admin/src/assets/vendors/iconfonts/mdi/css/materialdesignicons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('asset/backend/admin/src/assets/vendors/iconfonts/ionicons/css/ionicons.css') }}">
    <link rel="stylesheet" href="{{ asset('asset/backend/admin/src/assets/vendors/iconfonts/typicons/src/font/typicons.css') }}">
    <link rel="stylesheet" href="{{ asset('asset/backend/admin/src/assets/vendors/iconfonts/flag-icon-css/css/flag-icon.min.css') }}">
    <link rel="stylesheet" href="{{ asset('asset/backend/admin/src/assets/vendors/css/vendor.bundle.base.css') }}">
    <link rel="stylesheet" href="{{ asset('asset/backend/admin/src/assets/vendors/css/vendor.bundle.addons.css') }}">
    <!-- endinject -->
    <!-- plugin css for this page -->
    <!-- End plugin css for this page -->
    <!-- inject:css -->
    <link rel="stylesheet" href="{{ asset('asset/backend/admin/src/assets/css/shared/style.css') }}">
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="{{ asset('asset/backend/admin/src/assets/css/demo_1/style.css') }}">
    <!-- End Layout styles -->
    <link rel="shortcut icon" href="{{ asset('asset/backend/admin/src/assets/images/favicon.png') }}" />
  </head>
  <body>
      ...
      <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html">
            <img src="{{ asset('asset/backend/admin/src/assets/images/logo.svg') }}" alt="logo" /> </a>
          <a class="navbar-brand brand-logo-mini" href="index.html">
            <img src="{{ asset('asset/backend/admin/src/assets/images/logo-mini.svg') }}" alt="logo" /> </a>
        </div>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
              <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <img class="img-xs rounded-circle" src="{{ asset('asset/backend/admin/src/assets/images/faces/face8.jpg') }}" alt="Profile image"> </a>
          ...
          <ul class="nav">
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                <div class="profile-image">
                  <img class="img-xs rounded-circle" src="{{ asset('asset/backend/admin/src/assets/images/faces/face8.jpg') }}" alt="profile image">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{ asset('asset/backend/admin/srcpages/samples/blank-page.html') }}"> Blank Page </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ asset('asset/backend/admin/srcpages/samples/login.html') }}"> Login </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ asset('asset/backend/admin/srcpages/samples/register.html') }}"> Register </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ asset('asset/backend/admin/srcpages/samples/error-404.html') }}"> 404 </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ asset('asset/backend/admin/srcpages/samples/error-500.html') }}"> 500 </a>
                  </li>
                </ul>
              </div>
            </li>
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="d-flex mt-3 py-2 border-bottom">
                          <img class="img-sm rounded-circle" src="{{ asset('asset/backend/admin/src/assets/images/faces/face3.jpg') }}" alt="profile image">
                        ...
                        <div class="d-flex py-2 border-bottom">
                          <img class="img-sm rounded-circle" src="{{ asset('asset/backend/admin/src/assets/images/faces/face4.jpg') }}" alt="profile image">
                          <div class="wrapper ml-2">

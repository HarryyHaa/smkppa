		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-12 col-md center">
					...
					<p>Smk Plus Pratama Adi didirikan di bawah naungan Yayasan Pratama Adi yang sudah berpengalaman mendidik dan mencetak siswa/siswi berprestasi ditunjang oleh guru-guru yang berpengalaman, professional dan berkompeten dalam bidang ilmu nya
                        sebagai upaya memenuhi tuntutan masyarakat dan industri global saat ini </p>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-push-5 animate-box">
						<img class="img-responsive" src="{{ asset('asset/frontend/smk/images/siswa2.jpg') }}" alt="work">
					</div>
		...
		<div class="container-fluid proj-bottom">
			<div class="row">
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="{{ asset('asset/frontend/smk/images/siswa1.jpg') }}" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Web Master</h3>
						...
						<div class="owl-carousel owl-carousel-fullwidth">
							<div class="item">
								<div class="testimony-slide active text-center">
									<figure>
										<img src="{{ asset('asset/frontend/smk/images/siswa1.jpg') }}" alt="user">
									</figure>
